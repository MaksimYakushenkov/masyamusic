...
export function PlayerBar() {
  ...
  return (
    <div style={barStyle}>
      {/* ── Mobile layout ── */}
      <div className="md:hidden flex flex-col px-4 pt-3 pb-2 gap-2">
        <div className="flex items-center gap-2.5">
          {/* Cover */}
          <div
            className="w-10 h-10 rounded-lg overflow-hidden flex-shrink-0"
            style={{ border: '1px solid var(--border)', boxShadow: '0 0 8px rgba(0,0,0,0.5)' }}
          >
          ...
          {/* Like */}
          {currentTrack && (
            <button onClick={handleLike} className="flex-shrink-0 p-2 -mr-1">
              {currentTrack.liked
          ...
          {/* Prev */}
          <button onClick={prev} className="flex-shrink-0 p-2" style={{ color: 'var(--text-muted)' }}>
          ...
          <button
            ...
            style={{
              ...
              boxShadow: currentTrack ? '0 0 16px var(--accent-glow)' : 'none',
            }}
          >
            {isPlaying
          ...
          {/* Next */}
          <button onClick={next} className="flex-shrink-0 p-2" style={{ color: 'var(--text-muted)' }}>
      ...
      {/* ── Desktop layout ── */}
      <div
        className="hidden md:grid grid-cols-3 items-center px-5 gap-4"
